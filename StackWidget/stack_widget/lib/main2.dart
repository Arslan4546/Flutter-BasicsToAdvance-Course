    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                  image: DecorationImage(
                      ...
                      fit:
                          BoxFit.fitWidth)), // Background color for cover photo
            ),
            const Positioned(
              top: 80,
              left: 16,
              child: CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: AssetImage(
                      'assets/images/a.png'), // Replace with profile picture URL
                ),
              ),
            ),
            const Positioned(
            ...
            const Padding(
              padding: EdgeInsets.only(top: 340.0, left: 10, right: 20),
              child: Row(
                children: [
                  Text(
              ...
              child: Row(
                children: [
                  ...
                  OutlinedButton.icon(
                    ...
                    label: const Text("Enhance Profile ",
            ...
            // Analytics Section
            const Padding(
              padding: EdgeInsets.only(top: 430.0, left: 16, right: 20),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Analytics",
