...
class ClockPainter extends CustomPainter {
  ...
  void _drawNeedles(Canvas canvas, Size size, Offset center) {
    ...
    // Angle calculation for demo purposes (static values for now)
    const hourAngle = 2 * pi / 12 * 6; // 3 o'clock position
    const minuteAngle = 2 * pi / 60 * 15; // 15 minutes position
    const secondAngle = 2 * pi / 60 * 45; // 45 seconds position
